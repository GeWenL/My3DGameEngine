...
#define WINDOW_TITLE      "WireframeEngine-云木"
#define WINDOW_WIDTH      1400 // size of window
...
int Game_Main(void *parms)
{
	...
	// draw the ground
	Draw_Rectangle(0, WINDOW_HEIGHT / 2, WINDOW_WIDTH - 1, WINDOW_HEIGHT - 1, RGB16Bit(23, 2, 90), lpddsback);
